 ...
 */
public class ReportDashboardHotelManagementJPanel extends javax.swing.JPanel {
     ...
     */
    public ReportDashboardHotelManagementJPanel(Business b, EmployeeProfile hmp, JPanel cardSequencePanel) {
        initComponents();
        business = b;
    ...
    private void showCharts() {
        ...
        barDataset.setValue("Total Rooms Left", new Double(totalRooms));
...
//        piePlot.setSectionPaint("Total Rooms", new Color(255, 255, 102));
//        piePlot.setSectionPaint("Total Booked Rooms", new Color(102, 255, 102));
